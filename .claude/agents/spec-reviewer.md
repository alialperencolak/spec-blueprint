---
name: spec-reviewer
description: Review a feature spec for completeness, testability, and constitution alignment. Invoke with Agent(subagent_type="spec-reviewer", prompt="review specs/features/<name>/spec.md").
model: haiku
tools:
  - Read
  - Glob
